...
/**
 * struct print - struct for printers functions
 * @type_arg: identifiers
 * @f: pointer to  printers function
 *
 * Descriptions: structs that stores pointers to a
 * printer functions.
 */
 ...
 * @id: pointer of the specifier i.e (l, h) for (d, i, u, o, x, X)
 * @f: pointer to a function for the conversion specifier
 *
 */
...
int _putchar(char c);
int _printf(const char *format, ...);
>>>>>>> 1488632494cfa3cf3e53e5d2f9010cb8f75f6798
